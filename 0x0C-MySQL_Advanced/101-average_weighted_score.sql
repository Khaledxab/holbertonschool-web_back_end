-- Creates a stored procedure ComputeAverageWeightedScoreForUsers that computes the average weighted score for all users
-- The procedure updates the average_score column of the users table for all users
